# Implement Prompt — imdbapi-client
...
You are implementing GitHub issue #[ISSUE_NUMBER] in `aharbii/imdbapi-client`.

Step 1: Fetch the issue.
  gh issue view [ISSUE_NUMBER] --repo aharbii/imdbapi-client
...
Step 10: Open PR.
  ...
  gh pr create --repo aharbii/imdbapi-client --title "..." --body "..."
...
Step 11: Comment on related issues from Agent Briefing.
  gh issue comment [N] --repo [REPO] --body "PR aharbii/imdbapi-client#[PR]: [url]. [what this means for that issue]"
